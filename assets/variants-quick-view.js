        ...
        if(unavailable){
            ...
            if (disable) {
                ...
                if(window.quick_view_subtotal.show) {
                    ...
                    if(window.quick_view_subtotal.layout == '1') {
                        if (typeof inventoryQuantity != 'undefined'){
                            if(inventoryQuantity > 0) {
                                text = window.quick_view_subtotal.text.replace('[value]', subTotal);
                            } else {
                                text = window.quick_view_subtotal.text_2.replace('[value]', subTotal);
                            }
                        } else{
                            text = window.quick_view_subtotal.text.replace('[value]', subTotal);
                        }
                    } else {
                        const subtotalLabel = document.getElementById(`product-quick-view-form-${this.dataset.product}`)?.querySelector('[data-product-subtotal]');
    ...
    onInputChange(event) {
        ...
        if(window.quick_view_subtotal.show) {
            ...
            if(window.quick_view_subtotal.layout == '1') {
                ...
                const subtotalLabel = document.getElementById(`product-quick-view-form-${this.input.dataset.product}`)?.querySelector('[data-product-subtotal]');
